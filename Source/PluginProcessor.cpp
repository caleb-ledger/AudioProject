    ...
    AudioPluginAudioProcessor::createParameterLayout()
{
    ...
    //Go from 20hz to 20,000hz at steps of 1, no skew factor, and default 20 hz
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("HighCut Freq", "HighCut Freq", juce::NormalisableRange<float>(20000.f, 20.f, 1.f, 1.f), 20000.f));
    ...
    layout.add(std::make_unique<juce::AudioParameterFloat>("Peak Quality", "Peak Quality", juce::NormalisableRange<float>(0.1, 10.f, 0.05f, 1.f), 1.f));
